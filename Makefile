...
include:
	...
	echo // >> $(RC)
ifdef HAVE_MIDAS
	echo "#define HAVE_MIDAS" >> $(RC)
	echo "//#define MIDASSYS $(MIDASSYS)" >> $(RC)
else
	echo "//#define HAVE_MIDAS" >> $(RC)
endif
ifdef HAVE_LIBZ
	echo "#define HAVE_LIBZ" >> $(RC)
else
	echo "//#define HAVE_LIBZ" >> $(RC)
endif
ifdef HAVE_ROOT
	echo "#define HAVE_ROOT" >> $(RC)
	echo "//#define ROOTSYS $(ROOTSYS)" >> $(RC)
else
	echo "//#define HAVE_ROOT" >> $(RC)
endif
ifdef HAVE_ROOT_HTTP
	echo "#define HAVE_ROOT_HTTP" >> $(RC)
else
	echo "//#define HAVE_ROOT_HTTP" >> $(RC)
endif
ifdef HAVE_ROOT_XML
	echo "#define HAVE_ROOT_XML" >> $(RC)
else
	echo "//#define HAVE_ROOT_XML" >> $(RC)
endif
ifdef HAVE_THTTP_SERVER
	echo "#define HAVE_THTTP_SERVER" >> $(RC)
else
	echo "//#define HAVE_THTTP_SERVER" >> $(RC)
endif
ifdef HAVE_XMLSERVER
	echo "#define HAVE_XMLSERVER" >> $(RC)
else
	echo "//#define HAVE_XMLSERVER" >> $(RC)
endif
ifdef HAVE_LIBNETDIRECTORY
	echo "#define HAVE_LIBNETDIRECTORY" >> $(RC)
else
	echo "//#define HAVE_LIBNETDIRECTORY" >> $(RC)
endif
	echo "// end" >> $(RC)
